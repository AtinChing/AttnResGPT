...
class SiglipAttnResCaptioner(nn.Module):
    def __init__(
        ...
        *,
        ...
        encoder_architecture: EncoderArchitecture = "frozen_baseline",
        encoder_attnres: AttnResConfig | None = None,
    ...
    @property
    def uses_frozen_vision_cache(self) -> bool:
        return self.encoder_architecture == "frozen_baseline"
    ...
    @property
    def supports_decoder_alpha_analysis(self) -> bool:
        return isinstance(self.decoder, GPTAttnRes)

    @property
    def supports_encoder_alpha_analysis(self) -> bool:
        return self.encoder_architecture == "attnres"
